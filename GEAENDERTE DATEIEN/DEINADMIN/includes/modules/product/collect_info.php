 ...
 * @version $Id: collect_info.php for Soundcloud 2022-06-04 19:44:50Z webchills $
 */
...
?>
  ...
  <div class="form-group">
   ...
   <!-- BOF soundcloud add-on -->
  <div class="form-group">
      <?php echo zen_draw_label(TEXT_PRODUCTS_SOUNDCLOUD, 'products_soundcloud', 'class="col-sm-3 control-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_input_field('products_soundcloud', htmlspecialchars(stripslashes($pInfo->products_soundcloud), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_soundcloud') . ' class="form-control"'); ?>
    </div>
  </div>
 <!-- EOF soundcloud add-on -->
