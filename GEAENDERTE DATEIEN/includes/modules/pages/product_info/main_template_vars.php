 ...
 * @version $Id: main_template_vars.php for Soundcloud 2022-06-04 19:47:36Z webchills $
 */
/*
...
// if review must be approved or disabled do not show review
  ...
  $products_soundcloud = $product_info->fields['products_soundcloud'];
...
// build show flags from product type layout settings
  ...
  $flag_show_product_info_soundcloud = zen_get_show_product_switch($_GET['products_id'], 'soundcloud');
